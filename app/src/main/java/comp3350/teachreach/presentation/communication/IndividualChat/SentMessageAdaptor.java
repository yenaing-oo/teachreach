...
public class SentMessageAdaptor extends RecyclerView.Adapter<SentMessageAdaptor.SendMessageViewHolder> {
    ...
    @NonNull
    @Override
    public SendMessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
...
//    @Override
//    public void onBindViewHolder(@NonNull SendMessageViewHolder sendMessageViewHolder, int position) {
//
//       // Map.Entry<Timestamp, String> messageEntry = sentmessages.get(position);
//        //sendMessageViewHolder.setMessageData(messageEntry.getKey(),messageEntry.getValue());
//        Map.Entry<Timestamp, String> messageEntry = getMessageEntry(position);
//        SendMessageViewHolder.setMessageData(messageEntry.getKey(), messageEntry.getValue();
//    }
    @Override
    public void onBindViewHolder(@NonNull SendMessageViewHolder holder, int position) {
        Map.Entry<Timestamp, String> messageEntry = getMessageEntry(position);
