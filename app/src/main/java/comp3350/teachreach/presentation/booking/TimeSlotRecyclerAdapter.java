...
class TimeSlotRecyclerAdapter extends RecyclerView.Adapter<TimeSlotRecyclerAdapter.ViewHolder>
{
    ...
    public
    TimeSlotRecyclerAdapter(List<ITimeSlice> timeSlots, IOnTimeSlotClickListener listener)
    {
    ...
    void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        cardView.setCardBackgroundColor(position == selectedPosition ?
                                        cardView.getContext().getColor(R.color.TIME_CLOT_CARD_BACKGROUND_PRESSED) :
                                        cardView.getContext().getColor(R.color.TIME_CLOT_CARD_BACKGROUND_DEFAULT));
    ...
    public
    void setSelectedPosition(ITimeSlice timeSlice, int position)
    {
