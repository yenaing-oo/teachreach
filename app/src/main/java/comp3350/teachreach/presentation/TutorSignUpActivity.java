...
public class TutorSignUpActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btnTutorSubmit.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            createTutorProfile();
  ...
  private void createTutorProfile() {
    ...
    if (newTutor != null) {
      Toast.makeText(
              TutorSignUpActivity.this, "Tutor Account Created Successfully!", Toast.LENGTH_SHORT)
          .show();
  ...
  private void openFilePicker() {
    ...
    try {
      startActivityForResult(
          Intent.createChooser(intent, "Select a File to Upload"), REQUEST_CODE_PICK_FILE);
