...
class TutorProfileSelfViewFragment extends Fragment {
    ...
    private void setUpTutoredCourses() {
        ...
        btnAddCourse.setOnClickListener(
                v -> addCourse.show(getChildFragmentManager(), "Add Course"));
        ...
        profileViewModel.getTutoredCoursesCode()
    ...
    private void setUpPreferredLocations() {
        ...
        btnAddLocation.setOnClickListener(
                v -> addLocation.show(getChildFragmentManager(), "Add Location"));
        ...
        recycler.setAdapter(recyclerAdapter);
        profileViewModel.getPreferredLocations()
                        .observe(getViewLifecycleOwner(), recyclerAdapter::updateData);
    }
