...
public class EditTutorProfileActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ITutorProfileHandler tutorProfile
                = new TutorProfileHandler(TRData.getCurrentTutorID());
    ...
    private void initializeFields(ITutorProfileHandler tutorProfile)
    {
    ...
    private void saveProfileChanges(ITutorProfileHandler tutorProfile)
    {
        try {
