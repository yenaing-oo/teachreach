...
public class StringRecyclerAdapter
        extends RecyclerView.Adapter<StringRecyclerAdapter.ViewHolder>
{
    ...
    @NonNull
    @Override
    public StringRecyclerAdapter.ViewHolder onCreateViewHolder(
    ...
    public void onBindViewHolder(
            @NonNull StringRecyclerAdapter.ViewHolder holder, int position)
    {
