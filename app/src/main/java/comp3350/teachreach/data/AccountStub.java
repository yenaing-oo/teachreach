  ...
  public AccountStub() {
    ...
    this.storeTutor(
        new Tutor(
            ...
            "$2a$12$xeTxmBShbtIWsT/kdxVD8.k2LI.RdOKAHYdRhgiw7Z5YxTd6.beOG",
            13.5));
    this.storeTutor(
        new Tutor(
            "Camryn Mcmillan",
            ...
            "$2a$12$LMXSy2E2SRxXOyUzT2hwuOV..lVkQHj5sVFgrTQF4QpJWVbo9CBie",
            20));
    this.storeTutor(
        new Tutor(
            "Justin Huang",
            "He/Him",
            "Computer Science",
            "huang15@myumanitoba.ca",
            "$2a$12$r9yuopZw8rOLVK.L9FU6k.kaZu3GtrcTvc/PBNleKVcWx/YE6Hc4G",
            17.5));
    this.storeTutor(
        new Tutor(
            "Ashna Sharma",
            ...
            "$2a$12$bnFp/uerz96t0CZwkRhNyuOFQTg54d9K0Pzkhdh/.8p2/ec1SFxjm",
            11));
    this.storeTutor(
        new Tutor(
            "Theo Brown",
