...
class BookingHandler
{
    ...
    public
    BookingHandler(ITutor theTutor)
    {
    ...
    public
    BookingHandler(String theTutorsEmail,
                   ITutorPersistence tutors,
                   IStudentPersistence students,
                   ISessionPersistence sessions)
    {
        ...
        this.theTutor       = tutorsDataAccess
                .getTutorByEmail(theTutorsEmail)
                .orElseThrow(NoSuchElementException::new);
        availabilityManager = new AvailabilityManager(theTutor);
    }

    public
    ISession requestNewSession(IStudent theStudent,
                               int day,
                               int month,
                               int year,
                               int hour,
                               ...
                               String location)
    {
        TimeSlice sessionTime = TimeSlice.of(year,
                                             month,
                                             day,
                                             hour,
                                             minute,
        ...
        if (availabilityManager.isAvailableAt(sessionTime)) {
            resultSession = sessionsDataAccess.storeSession(theStudent,
                                                            theTutor,
                                                            sessionTime,
                                                            location);
        } else {
    ...
    public
    List<ISession> getPendingSessionRequests()
    {
